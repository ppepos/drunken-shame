...
build-all: build-crypto1 build-crypto2 build-crypto3 build-crypto4 build-sql1 build-sql2 build-sql3 build-sql4

run-all: run-crypto1 run-crypto2 run-crypto3 run-crypto4 run-sql1 run-sql2 run-sql3 run-sql4
